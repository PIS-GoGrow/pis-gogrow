...
class Consumer::DashboardIndexSerializer < ApplicationSerializer
  ...
  typelize order_confirmation: "{ total: number; orders: Array<{ id: number; date: string; address: string; address_label: string; provider_name: string; name: string; quantity: number; discounted_price: number }> } | null"
end
