...
export default function Index({ menus }: MenuProps) {
  ...
  const [deletingMenu, setDeletingMenu] = useState<{ id: number | null; name: string }>({id: null, name: ''})
  ...
  return (
    <div className="m-5 w-200 mx-auto grid gap-2">
      ...
      <Dialog open={openDelete} onOpenChange={setOpenDelete}>
        ...
        <DeleteMenuDialog name={deletingMenu.name} id={deletingMenu.id} setOpenDelete={setOpenDelete} />
      </Dialog>
    </div>
  )
}
