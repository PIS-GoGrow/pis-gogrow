...
if (first_schedule = upcoming_schedules.first)
  order = Order.create!(consumer:, schedule: first_schedule, status: :pending, price: 300.50, discounted_price: 150.25, amount: 1, address: company.address, delivery_method: :office)
...
Order.create!(consumer:, schedule: past_schedule, status: :confirmed, price: 300.50, discounted_price: 150.25, amount: 1, address: company.address, delivery_method: :office)
Order.new(consumer:, status: :confirmed, price: 300.50, discounted_price: 150.25, amount: 1, delivery_method: :office).save!(validate: false)
